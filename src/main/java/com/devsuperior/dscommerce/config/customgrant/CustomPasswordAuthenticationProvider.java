...
public class CustomPasswordAuthenticationProvider implements AuthenticationProvider {
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		...
		com.devsuperior.dscommerce.config.customgrant.CustomPasswordAuthenticationToken customPasswordAuthenticationToken = (com.devsuperior.dscommerce.config.customgrant.CustomPasswordAuthenticationToken) authentication;
		...
		com.devsuperior.dscommerce.config.customgrant.CustomUserAuthorities customPasswordUser = new com.devsuperior.dscommerce.config.customgrant.CustomUserAuthorities(username, user.getAuthorities());
	...
	public boolean supports(Class<?> authentication) {
		return com.devsuperior.dscommerce.config.customgrant.CustomPasswordAuthenticationToken.class.isAssignableFrom(authentication);
	}
